...
namespace IIS.dfgdf88989
{
    ...
    public class Paws : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.dfgdf88989.Cat fCat;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.dfgdf88989.Cat.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Cat"})]
        public virtual IIS.dfgdf88989.Cat Cat
        {
            get
            {
                ...
                IIS.dfgdf88989.Cat result = this.fCat;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View PawsE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("PawsE", typeof(IIS.dfgdf88989.Paws));
                }
            }
        }
    }
    ...
    public class DetailArrayOfPaws : ICSSoft.STORMNET.DetailArray
    {
        ...
        //  *** Start programmer edit section *** (IIS.dfgdf88989.DetailArrayOfPaws members)

        //  *** End programmer edit section *** (IIS.dfgdf88989.DetailArrayOfPaws members)
        ...
        /// </summary>
        public DetailArrayOfPaws(IIS.dfgdf88989.Cat fCat) : 
                base(typeof(Paws), ((ICSSoft.STORMNET.DataObject)(fCat)))
        {
        }
        
        public IIS.dfgdf88989.Paws this[int index]
        {
            get
            {
                return ((IIS.dfgdf88989.Paws)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.dfgdf88989.Paws dataobject)
        {
