...
namespace IIS.dfgdf88989
{
    ...
    [View("CatL", new string[] {
            "CatName as \'Cat name\'",
            "Weight as \'Weight\'"})]
    public class Cat : IIS.dfgdf88989.Animal
    {
        
        private string fCatName;
        
        private IIS.dfgdf88989.DetailArrayOfPaws fPaws;
        ...
        public virtual IIS.dfgdf88989.DetailArrayOfPaws Paws
        {
            get
            {
                ...
                if ((this.fPaws == null))
                {
                    this.fPaws = new IIS.dfgdf88989.DetailArrayOfPaws(this);
                }
                IIS.dfgdf88989.DetailArrayOfPaws result = this.fPaws;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View CatE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CatE", typeof(IIS.dfgdf88989.Cat));
                }
            }
            ...
            public static ICSSoft.STORMNET.View CatL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CatL", typeof(IIS.dfgdf88989.Cat));
                }
            }
        }
    }
